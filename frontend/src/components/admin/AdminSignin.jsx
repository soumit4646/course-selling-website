...
export default function AdminSignin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("/api/v1/admin/signin", {
        email,
        password,
      });
  ...
  return (
    <div className="border rounded max-w-[90vw] md:max-w-xl mx-auto p-4">
      <h1 className="text-center mb-4 text-4xl font-bold">Admin Login Form</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p>
          ...
          <Link to="/admin/auth/signup" className="text-blue-600">
            Signup
          </Link>
        </p>
      </form>
